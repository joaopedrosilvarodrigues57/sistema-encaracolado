...
labels = ['Acima da média anual','Abaixo da média anual', 'Total de Vazões']  # subtítulos do gráfico.
values = [va, vb, 4383]   # armazena na variável values a lista dos valores obtidos.
...
fig.update_layout(                                                         # atualiza o layout do gráfico.
    ...
    annotations=[dict(text='DVMMMA', x=0.5, y=0.5, font_size=20, showarrow=False)]) # adiciona a sigla DVMMM no meio do gráfico. 
